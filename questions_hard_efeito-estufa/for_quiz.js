document.addEventListener('DOMContentLoaded', () => {
    ...
    if (performance.navigation.type === performance.navigation.TYPE_RELOAD) {
        ...
        localStorage.removeItem('totalAnswered');
        localStorage.removeItem('currentQuestionNumber');
        window.location.href = 'efeito-estufa_quiz_1_hard.html';
    }
    ...
    nextButton.addEventListener('click', () => {
        ...
        if (!questionChecked) {
            ...
            if (totalAnswered >= 15) {
                ...
                history.pushState({ questionNumber }, '', `e_f_q_${questionNumber}_h.html`);

                // Redireciona para a próxima página
                window.location.href = `e_f_q_${questionNumber}_h.html`;
            }
        }
    });
